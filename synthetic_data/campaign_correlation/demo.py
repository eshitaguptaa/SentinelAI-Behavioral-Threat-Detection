"""Demo kill-chain feature vectors for EMP-K01 (3-stage campaign).

Used by the SOC sample batch so Investigate can expand one alert into a
full campaign timeline. ``campaign_id`` is correlation metadata only —
never consumed by ``ml_features()``.
"""
...
DEMO_CAMPAIGN_ID = "CMP-DEMO-BRUTE-EXFIL"
DEMO_CAMPAIGN_EMPLOYEE = "EMP-K01"

# Brute Force → Lateral Movement → Mass Download (spaced across 3 days)
DEMO_CAMPAIGN_VECTORS: list[dict[str, Any]] = [
    {
        ...
        "resource_entropy": 1.1,
        "device_entropy": 0.5,
        "after_hours_event_count": 4,
        "download_size_mb_sum": 3.0,
        "mass_download_event_count": 0,
        "vpn_usage_ratio": 0.2,
        "burst_max_5min": 20.0,
        "active_duration_hours": 6.0,
        "file_access_ratio": 0.05,
        "night_event_count": 1,
        "application_access_count": 2,
        "file_access_count": 1,
    ...
    },
    {
        ...
        "download_size_mb_sum": 18.0,
        "mass_download_event_count": 0,
        "vpn_usage_ratio": 0.35,
        "burst_max_5min": 14.0,
        "active_duration_hours": 9.0,
        "file_access_ratio": 0.22,
        "night_event_count": 2,
        "application_access_count": 4,
        "file_access_count": 5,
        "demo_kind": "confirmed_attack",
    ...
    },
    {
        ...
        "download_size_mb_sum": 240.0,
        "mass_download_event_count": 4,
        "vpn_usage_ratio": 0.45,
        "burst_max_5min": 18.0,
        "active_duration_hours": 10.0,
        "file_access_ratio": 0.6,
        "night_event_count": 3,
        "application_access_count": 2,
        "file_access_count": 12,
        "demo_kind": "confirmed_attack",
        "attack_scenario": "Mass Download",
    },
]
